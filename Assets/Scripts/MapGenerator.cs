...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        //fisher-yates shuffle method for generating obstacles
        //Generating coordinats
        ...
        {
            //Destroy immedieate because of the changes in the editor in runtime
        ...
        // spawning obstacles and checking there are no dead zones/blocked pathways
        ...
        for (int i =0; i < obstacleCount; i ++) 
        {
            ...
            if (randomCoord != currentMap.mapCentre && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
                ...
                obstacleMaterial.color =
                    Color.Lerp(currentMap.foregroundColor, currentMap.bacgroundColor, colorPercent);
        ...
        // Creating navmeshmask in order to not let ai to go out of the boundries of the map
        Transform maskLeft = 
    ...
    public Transform GetTileFromPosiion(Vector3 position)
    {
